...
export const NEXTJS_ENHANCED_QUESTIONS = {
  ...
  senior: [
    ...
    },
    {
      id: "nextjs-senior-23",
      question:
        "Your Next.js e-commerce application needs to work offline for users in areas with poor connectivity. Users should be able to browse products and add items to cart even without internet. What's the most critical PWA feature to implement first?",
      type: "multiple-choice",
      options: [
        {
          id: "a",
          text: "Service Worker with strategic caching for product data and cart functionality",
          isCorrect: true,
        },
        {
          id: "b",
          text: "Push notifications for new products",
          isCorrect: false,
        },
        {
          id: "c",
          text: "App installation prompts",
          isCorrect: false,
        },
        {
          id: "d",
          text: "Background sync for analytics",
          isCorrect: false,
        },
      ],
      explanation:
        "Service Workers with strategic caching enable offline functionality by storing product data and cart state locally, allowing users to browse and interact with the app without internet connectivity.",
    ...
    },
    {
      id: "nextjs-senior-24",
      question:
        "Your Next.js application needs to implement personalized product recommendations using machine learning. The current approach uses simple rule-based filtering. You have user behavior data but no ML infrastructure. What's the most practical first step?",
      type: "multiple-choice",
      options: [
        {
          id: "a",
          text: "Implement client-side ML with TensorFlow.js for collaborative filtering",
          isCorrect: true,
        },
        {
          id: "b",
          text: "Build a complete ML pipeline from scratch",
          isCorrect: false,
        },
        {
          id: "c",
          text: "Use only server-side ML processing",
          isCorrect: false,
        },
        {
          id: "d",
          text: "Implement complex neural networks immediately",
          isCorrect: false,
        },
      ],
      explanation:
        "TensorFlow.js enables client-side ML for personalized recommendations without server infrastructure. Collaborative filtering can provide immediate value using existing user behavior data.",
      category: "Machine Learning Integration",
      difficulty: "hard",
      tags: ["ml", "tensorflow", "recommendations", "personalization"],
      points: 3,
    },
    {
      id: "nextjs-senior-25",
      question:
        "Your Next.js application needs to integrate with a blockchain for NFT marketplace functionality. Users should be able to connect wallets, view NFT collections, and make purchases. The current implementation has wallet connection issues and slow transaction processing. What's the most critical improvement needed?",
      type: "multiple-choice",
      options: [
        {
          id: "a",
          text: "Implement Web3.js with proper wallet integration and transaction optimization",
          isCorrect: true,
        },
        {
          id: "b",
          text: "Use only client-side blockchain processing",
          isCorrect: false,
        },
        {
          id: "c",
          text: "Implement server-side blockchain validation only",
          isCorrect: false,
        },
        {
          id: "d",
          text: "Use traditional payment methods instead",
          isCorrect: false,
        },
      ],
      explanation:
        "Web3.js provides proper wallet integration and transaction optimization for blockchain interactions. It handles wallet connections, smart contract interactions, and transaction management efficiently.",
      category: "Blockchain Integration",
      difficulty: "hard",
      tags: ["blockchain", "web3", "nft", "wallet-integration"],
      points: 3,
    },
    {
      id: "nextjs-senior-26",
      question:
        "Your Next.js video streaming platform is experiencing buffering issues and poor quality on mobile devices. Users report 5-10 second loading times and frequent quality drops. The current setup uses basic video tags. What's the most effective solution?",
      type: "multiple-choice",
      options: [
        {
          id: "a",
          text: "Implement adaptive bitrate streaming with HLS/DASH and CDN optimization",
          isCorrect: true,
        },
        {
          id: "b",
          text: "Increase video file sizes for better quality",
          isCorrect: false,
        },
        {
          id: "c",
          text: "Use only client-side video processing",
          isCorrect: false,
        },
        {
          id: "d",
          text: "Disable video compression",
          isCorrect: false,
        },
      ],
      explanation:
        "Adaptive bitrate streaming (HLS/DASH) automatically adjusts video quality based on network conditions and device capabilities, reducing buffering and improving user experience across different devices.",
      category: "Video Streaming",
      difficulty: "hard",
      tags: ["video-streaming", "hls", "dash", "adaptive-bitrate"],
      points: 3,
    },
    {
      id: "nextjs-senior-27",
      question:
        "Your Next.js e-commerce application is experiencing payment failures and security concerns. Users report failed transactions, and there are PCI compliance issues. The current payment integration is basic and lacks proper error handling. What's the most critical improvement needed?",
      type: "multiple-choice",
      options: [
        {
          id: "a",
          text: "Implement Stripe with proper error handling, PCI compliance, and webhook validation",
          isCorrect: true,
        },
        {
          id: "b",
          text: "Use only client-side payment processing",
          isCorrect: false,
        },
        {
          id: "c",
          text: "Store payment data in local database",
          isCorrect: false,
        },
        {
          id: "d",
          text: "Use basic HTML forms for payments",
          isCorrect: false,
        },
      ],
      explanation:
        "Stripe provides secure payment processing with PCI compliance, comprehensive error handling, and webhook validation for reliable transaction management and security.",
      category: "Payment Processing",
      difficulty: "hard",
      tags: ["payments", "stripe", "pci-compliance", "security"],
      points: 3,
    },
    {
      id: "nextjs-senior-28",
      question:
        "Your Next.js application needs to send transactional emails (welcome, password reset, order confirmations) to 50,000+ users daily. The current email system is unreliable with 15% failure rate and slow delivery. What's the most effective solution?",
      type: "multiple-choice",
      options: [
        {
          id: "a",
          text: "Implement SendGrid with template management and delivery tracking",
          isCorrect: true,
        },
        {
          id: "b",
          text: "Use only SMTP servers",
          isCorrect: false,
        },
        {
          id: "c",
          text: "Send emails directly from the application",
          isCorrect: false,
        },
        {
          id: "d",
          text: "Use basic email libraries only",
          isCorrect: false,
        },
      ],
      explanation:
        "SendGrid provides reliable email delivery with 99%+ success rates, template management for consistent branding, and delivery tracking for monitoring email performance.",
      category: "Email Systems",
      difficulty: "hard",
      tags: ["email", "sendgrid", "delivery", "templates"],
      points: 3,
    },
    {
      id: "nextjs-senior-29",
      question:
        "Your Next.js application needs to handle user file uploads (images, documents, videos) with 100MB+ file sizes. The current system stores files locally and causes server storage issues. Users report slow upload times and storage errors. What's the most effective solution?",
      type: "multiple-choice",
      options: [
        {
          id: "a",
          text: "Implement AWS S3 with CloudFront CDN and multipart uploads",
          isCorrect: true,
        },
        {
          id: "b",
          text: "Store all files in the application database",
          isCorrect: false,
        },
        {
          id: "c",
          text: "Use only local server storage",
          isCorrect: false,
        },
        {
          id: "d",
          text: "Compress all files to reduce size",
          isCorrect: false,
        },
      ],
      explanation:
        "AWS S3 with CloudFront CDN provides scalable file storage with global distribution, while multipart uploads enable efficient handling of large files (100MB+) with better reliability and performance.",
      category: "File Storage",
      difficulty: "hard",
      tags: ["file-storage", "aws-s3", "cloudfront", "multipart-uploads"],
      points: 3,
    },
    {
      id: "nextjs-senior-30",
      question:
        "Your Next.js e-commerce application has 1 million+ products and users are complaining about slow search results. The current search implementation uses basic database queries with 3-5 second response times. Users expect sub-second search results. What's the most effective solution?",
      type: "multiple-choice",
      options: [
        {
          id: "a",
          text: "Implement Elasticsearch with full-text search and faceted filtering",
          isCorrect: true,
        },
        {
          id: "b",
        ...
        {
          id: "c",
          text: "Use only client-side search filtering",
          isCorrect: false,
        },
        {
          id: "d",
          text: "Implement basic LIKE queries",
          isCorrect: false,
        },
      ],
      explanation:
        "Elasticsearch provides sub-second search performance for large datasets with full-text search capabilities, faceted filtering, and advanced search features that scale to millions of products.",
      category: "Search Functionality",
      difficulty: "hard",
      tags: ["search", "elasticsearch", "full-text-search", "performance"],
      points: 3,
    },
  ] as InteractiveQuizQuestion[],
};
