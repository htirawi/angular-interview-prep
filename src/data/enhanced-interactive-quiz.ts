...
export const REACT_ENHANCED_QUESTIONS = {
  junior: [
    ...
    },
    {
      ...
      correctAnswer: "true",
      explanation:
        "React is a JavaScript library for building user interfaces, not a complete framework like Angular or Vue.",
      category: "React Basics",
      difficulty: "easy",
      tags: ["react", "basics"],
      points: 1,
    ...
    },
    {
      ...
      correctAnswer: "JSX",
      explanation:
        "React components are typically written using JSX syntax, which allows HTML-like code in JavaScript.",
      category: "React JSX",
      difficulty: "easy",
      tags: ["react", "jsx"],
      points: 1,
    },
    {
      ...
      correctAnswer: "true",
      explanation:
        "React uses one-way data binding, where data flows from parent to child components through props.",
    ...
    },
    {
      ...
      options: [
        {
          id: "a",
          text: "Data passed from parent to child components",
          isCorrect: true,
        },
        {
          id: "b",
          text: "Internal state of a component",
          isCorrect: false,
        },
        {
          id: "c",
      ...
      explanation:
        "Props are data passed from parent to child components in React. They are read-only and cannot be modified by the child component.",
    ...
    },
    {
      ...
      correctAnswer: "false",
      explanation:
        "React components can return JSX, null, or other React elements. They don't always have to return JSX.",
      category: "React Components",
      difficulty: "easy",
      tags: ["react", "components"],
      points: 1,
    },
    {
      ...
      options: [
        {
          id: "a",
          text: "To help React identify which items have changed",
          isCorrect: true,
        },
        {
          id: "b",
        ...
        {
          id: "c",
          text: "To sort list items",
          isCorrect: false,
        },
        {
          id: "d",
          text: "To hide list items",
          isCorrect: false,
        },
      ],
      explanation:
        "The key prop helps React identify which items have changed, been added, or removed in lists for efficient re-rendering.",
    ...
    },
    {
      ...
      options: [
        {
          id: "a",
          text: "State is internal and mutable, props are external and read-only",
          isCorrect: true,
        },
        {
          id: "b",
          text: "State is external and read-only, props are internal and mutable",
          isCorrect: false,
        },
        {
          id: "c",
        ...
        {
          id: "d",
          text: "State is for styling, props are for data",
          isCorrect: false,
        },
      ],
      explanation:
        "State is internal to a component and can be changed, while props are passed from parent components and are read-only.",
    ...
    {
      id: "react-junior-22",
      question: "State is _____ to a component, while props are passed from _____ components.",
      type: "fill-blank",
      correctAnswer: "internal, parent",
      explanation:
        "State is internal to a component and can be modified, while props are passed from parent components and are read-only.",
      category: "React State vs Props",
      difficulty: "easy",
      tags: ["react", "state", "props"],
      points: 1,
    ...
    },
    {
      ...
      explanation:
        "The dependency array in useEffect controls when the effect runs. If the array is empty, the effect runs only once after the initial render.",
      category: "React Hooks",
      difficulty: "easy",
      tags: ["react", "hooks", "useEffect"],
      points: 1,
    ...
    },
    {
      ...
      correctAnswer: "true",
      explanation:
        "React components automatically re-render when their state or props change, ensuring the UI stays in sync with the data.",
    ...
    },
    {
      ...
      options: [
        {
          id: "a",
          text: "Changes to state or props",
          isCorrect: true,
        },
        {
          id: "b",
        ...
        {
          id: "c",
          text: "Changes to HTML",
          isCorrect: false,
        },
        {
          id: "d",
          text: "Changes to JavaScript",
          isCorrect: false,
        },
      ],
      explanation:
        "React components re-render when their state or props change, ensuring the UI reflects the current data.",
      category: "React Rendering",
      difficulty: "easy",
      tags: ["react", "rendering"],
      points: 1,
    },
    {
      ...
      explanation:
        "React components re-render when their state or props change, keeping the UI synchronized with the data.",
      category: "React Rendering",
      difficulty: "easy",
      tags: ["react", "rendering"],
      points: 1,
    ...
    },
    {
      ...
      explanation:
        "React.memo helps optimize React performance by preventing unnecessary re-renders when props haven't changed.",
      category: "React Performance",
      difficulty: "easy",
      tags: ["react", "performance", "memo"],
      points: 1,
