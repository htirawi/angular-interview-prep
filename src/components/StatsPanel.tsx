...
export default function StatsPanel({ total, completed, bookmarked }: StatsPanelProps) {
  ...
  return (
    <div className="grid grid-cols-3 gap-4 rounded-xl border border-gray-200 bg-white p-4 dark:border-gray-700 dark:bg-gray-800">
      <div className="text-center">
        <div className="text-2xl font-bold text-blue-600 dark:text-blue-400">{completed}</div>
